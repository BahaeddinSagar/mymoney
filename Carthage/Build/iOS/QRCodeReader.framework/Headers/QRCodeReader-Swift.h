...
/**
  Reader object base on the \code
  AVCaptureDevice
  \endcode to read / scan 1D and 2D codes.
*/
...
/**
  ...
  \endcode is sets to true (default behaviour), each time the scanner found a code it calls the \code
  stopScanning
  \endcode method.</em>
*/
- (void)startScanning;
...
/**
  Convenient controller to display a view to scan/read 1D or 2D bar codes like the QRCodes. It is based on the \code
  AVFoundation
  \endcode framework from Apple. It aims to replace ZXing or ZBar for iOS 7 and over.
*/
